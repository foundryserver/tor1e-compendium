export class Tor1eCompendiumAdversaires {
  async creationAdversaires() {
    ...
    let monActor1 = await this.ajouteUnAdversaire(dossierOrcsGob, "Great Orc", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 7, 48, "", 8, 5, false, 3, true, 2, false, 2, true, 2, false, 2, false, 2, true, false);
    ...
    let monActor2 = await this.ajouteUnAdversaire(dossierOrcsGob, "Snaga Tracker", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 2, 8, "", 2, 3, false, 2, false, 2, false, 2, true, 2, true, 1, false, 1, false, false);
    ...
    let monActor3 = await this.ajouteUnAdversaire(dossierOrcsGob, "Black Uruk", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 5, 20, "", 4, 5, false, 3, false, 3, true, 3, true, 2, true, 1, false, 2, false, false);
    ...
    let monActor4 = await this.ajouteUnAdversaire(dossierOrcsGob, "Lugburz Messenger", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 4, 18, "", 5, 0, false, 3, true, 2, false, 2, false, 2, true, 2, true, 3, false, false);
    ...
    let monActor5 = await this.ajouteUnAdversaire(dossierOrcsGob, "Orc Chief", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 5, 20, "Animosity: Mount Gram (Hobbits), Goblin-town (Dwarves)", 5, 4, false, 3, false, 3, true, 2, false, 2, true, 1, false, 3, true, false);
    ...
    let monActor6 = await this.ajouteUnAdversaire(dossierOrcsGob, "Goblin Bowher", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 2, 8, "Animosity: Mount Gram (Hobbits), Goblin-town (Dwarves)", 1, 2, false, 1, false, 3, true, 2, false, 2, false, 1, false, 1, false, false);
    ...
    let monActor7 = await this.ajouteUnAdversaire(dossierOrcsGob, "Orc Guard", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 4, 16, "Animosity: Mount Gram (Hobbits), Goblin-town (Dwarves)", 3, 4, false, 2, false, 3, false, 3, true, 2, false, 2, true, 1, false, false);
    ...
    let monActor8 = await this.ajouteUnAdversaire(dossierOrcsGob, "Orc Soldier", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 3, 12, "Animosity: Mount Gram (Hobbits), Goblin-town (Dwarves)", 1, 3, false, 2, false, 2, false, 3, false, 2, true, 1, false, 1, false, false);
    ...
    let monActor10 = await this.ajouteUnAdversaire(dossierOrcsGob, "New Great Goblin", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 7, 60, "", 8, 3, false, 3, true, 1, false, 2, false, 2, false, 3, true, 3, true, true);
    ...
    let monActor11 = await this.ajouteUnAdversaire(dossierOrcsGob, "Maghaz, Orc Captain", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 4, 14, "", 5, 3, false, 3, true, 1, false, 2, false, 2, true, 2, false, 3, false, true);
    ...
    let monActor12 = await this.ajouteUnAdversaire(dossierOrcsGob, "Forest Goblin", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 2, 10, "", 2, 1, false, 1, false, 3, true, 2, false, 2, true, 1, false, 1, false, false);
    ...
    let monActor13 = await this.ajouteUnAdversaire(dossierOrcsGob, "Ghor the Swindler", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 6, 35, "", 6, 5, true, 3, true, 2, false, 2, true, 2, false, 2, false, 2, false, true);
    ...
    let monActor14 = await this.ajouteUnAdversaire(dossierOrcsGob, "Burzash, War Lord", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 7, 48, "", 8, 5, false, 3, false, 2, false, 2, true, 2, false, 2, false, 2, true, true);
    ...
    let monActor16 = await this.ajouteUnAdversaire(dossierOrcsGob, "Mount Gram Orc", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 4, 14, "The Orcs of Gram have not forgotten the crushing defeat inflicted by Bandobras Took, the Bullroarer, and since then harbor a fierce hatred for all Hobbits. Their ambition also leads them to conspire against neighboring Orcs and to lead a patrol of Rangers toward the site of a rival Orc community.", 4, 3, false, 3, false, 2, false, 2, true, 2, true, 1, false, 1, false, false);
    ...
    let monActor17 = await this.ajouteUnAdversaire(dossierOrcsGob, "Radgul the Orc Chief", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 6, 35, "Leader of the Orcs of Mount Gram. An old, scarred, gnarled, and ambitious Orc who aims for the throne of Mount Gundabad through patience and cunning.", 9, 6, false, 4, true, 2, true, 3, false, 3, true, 2, false, 2, false, true);
    ...
    let monActor19 = await this.ajouteUnAdversaire(dossierOrcsGob, "The Ruthless", "modules/fvtt-tor1e-compendium/icons/adv-orc.webp", 7, 48, "<b>Location</b>: Tower of the Flame of Ice, Frozen Valley (Nan Gorthrim), Angmar", 8, 5, false, 3, true, 2, false, 3, true, 2, false, 2, false, 3, true, true);
    ...
    let monActor20 = await this.ajouteUnAdversaire(dossierAraignees, "Attercop the Spider", "modules/fvtt-tor1e-compendium/icons/adv-araignee.webp", 3, 12, "", 2, 4, false, 1, false, 3, true, 1, true, 1, false, 1, false, 1, false, false);
    ...
    let monActor21 = await this.ajouteUnAdversaire(dossierAraignees, "Cave Spider", "modules/fvtt-tor1e-compendium/icons/adv-araignee.webp", 3, 12, "", 2, 4, false, 1, false, 3, true, 1, true, 1, false, 1, false, 1, false, false);
    ...
    let monActor22 = await this.ajouteUnAdversaire(dossierAraignees, "Great Spider", "modules/fvtt-tor1e-compendium/icons/adv-araignee.webp", 4, 36, "", 3, 5, false, 3, false, 3, true, 2, true, 2, false, 2, false, 1, false, false);
    ...
    let monActor23 = await this.ajouteUnAdversaire(dossierAraignees, "Hunter Spider", "modules/fvtt-tor1e-compendium/icons/adv-araignee.webp", 4, 25, "", 3, 6, false, 2, false, 3, true, 2, false, 3, true, 1, false, 1, false, false);
    ...
    let monActor24 = await this.ajouteUnAdversaire(dossierAraignees, "Sarqin the Fat", "modules/fvtt-tor1e-compendium/icons/adv-araignee.webp", 8, 90, "", 8, 5, true, 4, false, 1, true, 3, false, 2, true, 3, false, 2, false, true);
    ...
    let monActor25 = await this.ajouteUnAdversaire(dossierAraignees, "Tauler The Savage", "modules/fvtt-tor1e-compendium/icons/adv-araignee.webp", 7, 60, "", 8, 8, true, 3, false, 4, true, 4, false, 4, true, 3, false, 3, false, true);
    ...
    let monActor26 = await this.ajouteUnAdversaire(dossierAraignees, "Tyulquin the Weaver", "modules/fvtt-tor1e-compendium/icons/adv-araignee.webp", 9, 60, "", 8, 7, true, 4, false, 3, true, 3, false, 3, true, 2, false, 4, true, true);
    ...
    let monActor27 = await this.ajouteUnAdversaire(dossierTrolls, "Cave Troll", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 7, 76, "", 8, 5, true, 2, false, 2, true, 1, true, 2, false, 0, false, 0, false, false);
    ...
    let monActor28 = await this.ajouteUnAdversaire(dossierTrolls, "Hill Troll", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 7, 84, "", 7, 5, false, 3, false, 2, false, 3, false, 2, false, 0, false, 2, false, false);
    ...
    let monActor29 = await this.ajouteUnAdversaire(dossierTrolls, "Hill Troll Chief", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 8, 90, "", 10, 6, false, 3, true, 2, false, 2, false, 2, false, 1, false, 3, false, false);
    ...
    let monActor30 = await this.ajouteUnAdversaire(dossierTrolls, "Mountain Troll", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 9, 96, "", 7, 7, false, 4, true, 2, false, 2, false, 3, false, 1, false, 1, false, false);
    ...
    let monActor31 = await this.ajouteUnAdversaire(dossierTrolls, "Stone Troll", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 6, 72, "", 5, 5, false, 2, false, 2, false, 2, true, 1, false, 1, true, 1, false, false);
    ...
    let monActor32 = await this.ajouteUnAdversaire(dossierTrolls, "Weakened Stone Troll", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 6, 60, "", 3, 5, false, 2, false, 2, false, 1, true, 1, false, 1, true, 1, false, false);
    ...
    let monActor33 = await this.ajouteUnAdversaire(dossierTrolls, "Snow Troll", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 8, 80, "", 8, 6, true, 3, false, 3, true, 2, false, 2, true, 0, false, 0, false, false);
    ...
    let monActor34 = await this.ajouteUnAdversaire(dossierTrolls, "Berk the Doorkeeper", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 6, 72, "Berk lives on the edge of the eastern road, where he likes to trap travelers by placing tree trunks on the road to force them to clear the way and tire themselves out. At night, he can then quietly raid the camp of the sleeping travelers. He lives in a troll hole that used to house 3 trolls, now petrified.", 5, 5, false, 2, false, 2, false, 2, true, 1, false, 1, true, 1, false, true);
    ...
    let monActor35 = await this.ajouteUnAdversaire(dossierTrolls, "Bloody-stump the Hunter", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 8, 95, "", 10, 4, false, 3, false, 2, false, 2, false, 3, true, 1, false, 3, false, true);
    ...
    let monActor37 = await this.ajouteUnAdversaire(dossierTrolls, "Rine, Queen of Rivenfort", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 7, 80, "", 6, 3, false, 3, true, 2, false, 2, false, 2, true, 2, true, 3, false, true);
    ...
    let monActor38 = await this.ajouteUnAdversaire(dossierTrolls, "Captain Mormog", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 9, 95, "", 10, 3, false, 4, true, 3, false, 3, true, 3, false, 2, false, 3, false, true);
    ...
    let monActor40 = await this.ajouteUnAdversaire(dossierLoups, "Pack Leader", "modules/fvtt-tor1e-compendium/icons/adv-loup.webp", 5, 16, "", 3, 6, false, 2, false, 3, false, 2, false, 3, false, 1, false, 1, true, false);
    ...
    let monActor41 = await this.ajouteUnAdversaire(dossierLoups, "Sauron's Molossus", "modules/fvtt-tor1e-compendium/icons/adv-loup.webp", 6, 20, "", 5, 6, false, 3, false, 3, true, 3, true, 2, true, 1, false, 3, false, false);
    ...
    let monActor42 = await this.ajouteUnAdversaire(dossierLoups, "Werewolf of Mirkwood", "modules/fvtt-tor1e-compendium/icons/adv-loup.webp", 8, 68, "", 12, 9, false, 2, true, 3, true, 3, false, 3, true, 1, false, 3, false, true);
    ...
    let monActor43 = await this.ajouteUnAdversaire(dossierLoups, "Nagrhaw, Warg Pack Leader", "modules/fvtt-tor1e-compendium/icons/adv-loup.webp", 6, 22, "", 6, 6, true, 3, true, 2, false, 3, false, 3, true, 2, false, 4, false, true);
    ...
    let monActor45 = await this.ajouteUnAdversaire(dossierLoups, "Warg of Rubicorne Pass", "modules/fvtt-tor1e-compendium/icons/adv-loup.webp", 6, 20, "", 5, 6, false, 3, false, 3, true, 3, true, 2, true, 1, false, 3, false, false);
    ...
    let monActor46 = await this.ajouteUnAdversaire(dossierLoups, "Wild Wolf-dog", "modules/fvtt-tor1e-compendium/icons/adv-loup.webp", 2, 10, "", 2, 5, false, 2, false, 2, false, 3, false, 1, false, 0, false, 0, false, false);
    ...
    let monActor47 = await this.ajouteUnAdversaire(dossierVampires, "Great Bat", "modules/fvtt-tor1e-compendium/icons/adv-vampire.webp", 3, 10, "", 2, 5, false, 1, false, 3, false, 3, false, 3, false, 0, false, 0, true, false);
    ...
    let monActor48 = await this.ajouteUnAdversaire(dossierVampires, "Secret Shadow", "modules/fvtt-tor1e-compendium/icons/adv-vampire.webp", 5, 35, "", 6, 7, false, 2, false, 3, true, 3, true, 3, false, 2, false, 2, true, false);
    ...
    let monActor49 = await this.ajouteUnAdversaire(dossierCreaturesDesMarais, "Hobgoblin", "modules/fvtt-tor1e-compendium/icons/adv-divers.webp", 4, 36, "", 5, 4, true, 1, false, 2, false, 3, true, 2, true, 1, false, 1, false, false);
    ...
    let monActor51 = await this.ajouteUnAdversaire(dossierCreaturesDesMarais, "Marsh Ogre", "modules/fvtt-tor1e-compendium/icons/adv-troll.webp", 6, 80, "", 6, 5, true, 1, false, 2, false, 2, true, 1, true, 0, false, 0, false, false);
    ...
    let monActor52 = await this.ajouteUnAdversaire(dossierCreaturesDesMarais, "Marsh Dweller", "modules/fvtt-tor1e-compendium/icons/adv-divers.webp", 4, 10, "", 2, 4, false, 2, false, 1, false, 1, false, 2, false, 1, true, 0, false, false);
    ...
    let monActor53 = await this.ajouteUnAdversaire(dossierEsprits, "Warg Spirit", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 3, 12, "Trait: Flees into the darkness and disappears when Hate reaches zero.", 3, 5, false, 1, false, 3, false, 2, true, 2, false, 0, false, 0, false, false);
    ...
    let monActor54 = await this.ajouteUnAdversaire(dossierEsprits, "Forest Specter", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 5, 54, "", 8, 7, false, 1, false, 3, false, 2, false, 1, false, 2, false, 3, false, false);
    ...
    let monActor57 = await this.ajouteUnAdversaire(dossierEsprits, "Forest Ghost", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 4, 50, "", 10, 6, false, 3, true, 3, false, 2, true, 3, false, 2, true, 2, false, true);
    ...
    let monActor58 = await this.ajouteUnAdversaire(dossierEsprits, "Messenger of Mordor", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 4, 50, "", 10, 6, false, 2, false, 3, true, 2, false, 3, true, 2, true, 2, false, true);
    ...
    let monActor59 = await this.ajouteUnAdversaire(dossierEsprits, "Lieutenant of Dol Guldur", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 5, 60, "", 12, 7, true, 4, true, 3, false, 4, true, 2, false, 2, false, 4, true, true);
    ...
    let monActor61 = await this.ajouteUnAdversaire(dossierEsprits, "Undead Warrior", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 3, 15, "", 4, 3, false, 0, false, 2, true, 1, false, 1, true, 0, false, 0, false, false);
    ...
    let monActor62 = await this.ajouteUnAdversaire(dossierEsprits, "Hobbit Archer Specter", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 4, 30, "", 3, 5, false, 3, true, 4, true, 3, false, 1, false, 3, false, 2, false, false);
    ...
    let monActor63 = await this.ajouteUnAdversaire(dossierEsprits, "Steward of Carn Dûm", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 4, 70, "", 6, 5, false, 2, false, 4, false, 3, true, 0, false, 1, false, 3, false, true);
    ...
    let monActor64 = await this.ajouteUnAdversaire(dossierEsprits, "The Spirit King", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 6, 74, "", 12, 7, true, 5, true, 4, false, 3, false, 2, false, 4, false, 3, true, true);
    ...
    let monActor65 = await this.ajouteUnAdversaire(dossierEsprits, "Barrow-wight", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 4, 54, "", 6, 4, true, 2, true, 3, false, 2, true, 1, false, 1, false, 2, false, false);
    ...
    let monActor66 = await this.ajouteUnAdversaire(dossierEsprits, "Muddy Soldier", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 3, 12, "", 3, 3, false, 0, false, 2, false, 1, false, 1, false, 0, false, 0, false, false);
    ...
    let monActor67 = await this.ajouteUnAdversaire(dossierEsprits, "Fallen Specter", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 4, 35, "", 6, 5, false, 2, false, 4, false, 3, true, 0, false, 1, false, 3, false, false);
    ...
    let monActor69 = await this.ajouteUnAdversaire(dossierEsprits, "The Witch-king (intangible form)", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 8, 90, "", 22, 0, false, 5, true, 3, true, 3, false, 3, true, 2, false, 5, true, true);
    ...
    let monActor71 = await this.ajouteUnAdversaire(dossierEsprits, "Húldrahir, Dúnadan Specter", "modules/fvtt-tor1e-compendium/icons/adv-esprit.webp", 6, 35, "", 9, 7, false, 3, true, 4, true, 3, false, 1, false, 3, false, 2, false, true);
    ...
    let monActor72 = await this.ajouteUnAdversaire(dossierDragonsBasilics, "Basilisk", "modules/fvtt-tor1e-compendium/icons/adv-dragon.webp", 6, 40, "", 3, 4, false, 1, false, 2, false, 2, true, 3, false, 1, false, 1, false, false);
    ...
    let monActor74 = await this.ajouteUnAdversaire(dossierDragonsBasilics, "The Forest Dragon", "modules/fvtt-tor1e-compendium/icons/adv-dragon.webp", 8, 99, "", 10, 6, true, 3, true, 4, true, 5, true, 4, true, 2, false, 3, false, true);
    ...
    let monActor75 = await this.ajouteUnAdversaire(dossierDivers, "Dire Hawk", "modules/fvtt-tor1e-compendium/icons/adv-divers.webp", 2, 10, "", 4, 5, false, 1, false, 2, false, 2, true, 2, false, 0, false, 0, false, false);
    ...
    let monActor76 = await this.ajouteUnAdversaire(dossierDivers, "The Well Thing", "modules/fvtt-tor1e-compendium/icons/adv-divers.webp", 4, 45, "", 6, 4, true, 0, false, 2, true, 3, false, 0, false, 0, false, 2, false, true);
    ...
    let monActor77 = await this.ajouteUnAdversaire(dossierDivers, "The Long Vale Watcher", "modules/fvtt-tor1e-compendium/icons/adv-divers.webp", 9, 90, "", 9, 9, false, 2, false, 3, true, 2, false, 3, true, 0, false, 0, false, true);
    ...
    let monActor78 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Hillman of Gundabad", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 4, 16, "", 3, 5, false, 1, false, 3, true, 2, false, 3, false, 2, false, 2, true, false);
    ...
    let monActor79 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Wild Man of Mirkwood", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 3, 15, "", 3, 3, false, 2, false, 2, true, 2, false, 2, true, 1, false, 0, false, false);
    ...
    let monActor80 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Valdis (Great Vampire)", "modules/fvtt-tor1e-compendium/icons/adv-vampire.webp", 7, 70, "", 12, 9, false, 3, false, 5, true, 4, true, 3, false, 2, false, 1, false, true);
    ...
    let monActor82 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Outlaw Archer", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 3, 14, "", 1, 3, false, 2, false, 3, false, 2, true, 2, false, 1, false, 1, false, false);
    ...
    let monActor83 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Outlaw Warrior", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 3, 14, "", 2, 4, false, 2, false, 2, true, 2, false, 2, true, 1, false, 2, false, false);
    ...
    let monActor84 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Eastern Warrior", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 3, 12, "", 2, 4, false, 2, false, 2, false, 1, false, 2, false, 2, true, 1, true, false);
    ...
    let monActor86 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Heddwyn, Angmar Sorcerer-Servant", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 6, 26, "Scarlet Madness: The target makes a Corruption test. Failure: The hero is Melancholic until the end of the encounter. On a bout of madness (rolling an Eye of Sauron), the hero succumbs to uncontrollable rage and turns against friends and allies for a number of rounds equal to their Wisdom value. The Loremaster takes control of the hero during this madness.", 6, 6, true, 3, true, 2, false, 2, false, 3, false, 3, false, 3, true, true);
    ...
    let monActor88 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Scoundrel of Esgaroth", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 2, 12, "", 2, 4, false, 1, false, 2, false, 2, false, 2, false, 2, false, 1, false, false);
    ...
    let monActor90 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Warrior of Tyrant's Hill", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 3, 16, "", 3, 4, false, 2, false, 2, false, 2, false, 3, false, 1, false, 3, false, false);
    ...
    let monActor92 = await this.ajouteUnAdversaire(dossierHommesMauvaisEriador, "Ruthless Bandits", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 4, 14, "", 3, 4, false, 1, false, 2, true, 2, false, 2, true, 1, false, 2, false, false);
    ...
    let monActor93 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Beorn (Bear Form)", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 9, 99, "", 12, 12, false, 5, true, 4, true, 3, false, 3, false, 0, false, 3, false);
    ...
    let monActor94 = await this.ajouteUnAdversaire(dossierHommesMauvaisRhovanion, "Gerold the Beorning", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 7, 20, "", 4, 4, false, 2, false, 4, true, 3, false, 2, true, 2, false, 1, false);
    ...
    let monActor98 = await this.ajouteUnAdversaire(dossierHommesMauvaisEriador, "Caradog, Hunter of Dunland", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 5, 15, "", 4, 4, false, 1, false, 2, true, 3, false, 3, false, 1, false, 3, false);
    ...
    let monActor99 = await this.ajouteUnAdversaire(dossierHommesMauvaisEriador, "Wathach the Seer", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 6, 14, "", 8, 4, false, 3, true, 2, false, 3, false, 1, false, 3, false, 3, true);
    ...
    let monActor101 = await this.ajouteUnAdversaire(dossierHommesMauvaisEriador, "Man-at-Arms of the Wagon Company", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 4, 12, "", 2, 3, false, 1, false, 2, true, 2, false, 2, false, 1, false, 2, true);
    ...
    let monActor102 = await this.ajouteUnAdversaire(dossierHommesMauvaisEriador, "Warrior of Dun", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 5, 16, "", 4, 5, false, 2, true, 3, false, 2, true, 3, false, 1, false, 1, false);
    ...
    let monActor103 = await this.ajouteUnAdversaire(dossierHommesMauvaisEriador, "Armed Villager", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 3, 10, "", 1, 3, false, 1, false, 1, false, 2, false, 2, false, 1, true, 1, false);
    ...
    let monActor104 = await this.ajouteUnAdversaire(dossierRohan, "Thelred, renegade rider of Rohan", "modules/fvtt-tor1e-compendium/icons/adv-homme-mauvais.webp", 6, 15, "", 5, 6, true, 2, false, 3, true, 3, true, 2, false, 1, false, 3, false);
