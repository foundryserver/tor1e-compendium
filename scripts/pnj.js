export class Tor1eCompendiumPNJ {
  async creationPNJs() {
    ...
    // CREATION DES ACTORS
    let monActor1 = await this.ajouteUnPNJ(
      dossierHommesDesBois,
      "Hartfast, son of Harmunt",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
      18,
      "<p><em>See Core Rule Book</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor2 = await this.ajouteUnPNJ(
      dossierHommesDesBois,
      "Beranald the Gatekeeper",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
      15,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor3 = await this.ajouteUnPNJ(
      dossierHommesDesBois,
      "Iwmud the Goatherd",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
    ...
    let monActor4 = await this.ajouteUnPNJ(
      dossierHommesDesBois,
      "Gárhild the Vixen",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor5 = await this.ajouteUnPNJ(
      dossierHommesDesBois,
    ...
    let monActor6 = await this.ajouteUnPNJ(
      dossierHommesMauvais,
      "Valdis (woman)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
      19,
    ...
    let monActor7 = await this.ajouteUnPNJ(
      dossierHommesMauvais,
      "Sorceress of the Black Forest",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
      20,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor8 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Guard of Lake-town",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor9 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Merchant of Esgaroth",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
      0,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor10 = await this.ajouteUnPNJ(
      dossierEsgaroth,
    ...
    let monActor11 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Craftsman (Boatman)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor12 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Craftsman (Hunter)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor13 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Craftsman (Cook)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor14 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Craftsman (Smith)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor15 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Craftsman (Herbalist)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor16 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Craftsman (Gardener)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor17 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Craftsman (Mason)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor18 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Craftsman (Carpenter)",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor19 = await this.ajouteUnPNJ(
      dossierEsgaroth,
    ...
    let monActor20 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Guard of the Guard",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor21 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Town Councillor",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor22 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Healer",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor23 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Boatman of Esgaroth",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor24 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Guild Archer",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      7,
    ...
    let monActor25 = await this.ajouteUnPNJ(
      dossierDale,
      "Royal Archer of Dale",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      6,
      20,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor26 = await this.ajouteUnPNJ(
      dossierBeornides,
      "Osred the Rider",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor27 = await this.ajouteUnPNJ(
      dossierBeornides,
      "Túrin the Tinker",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      2,
    ...
    let monActor28 = await this.ajouteUnPNJ(
      dossierBeornides,
      "Gelvira Pot-stirrer",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
    ...
    let monActor29 = await this.ajouteUnPNJ(
      dossierBeornides,
    ...
    let monActor30 = await this.ajouteUnPNJ(
      dossierBeornides,
      "Dwarf Smith",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor31 = await this.ajouteUnPNJ(
      dossierNains,
      "Bofri, son of Bofur",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      3,
      21,
      "<p><em>See Core Rule Book</em></p>",
      false,
    ...
    let monActor32 = await this.ajouteUnPNJ(
      dossierNains,
      "Dwarf Noble",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor33 = await this.ajouteUnPNJ(
      dossierNains,
      "Frar the Beardless",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      4,
    ...
    let monActor34 = await this.ajouteUnPNJ(
      dossierNains,
      "Tholin the Merchant",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor35 = await this.ajouteUnPNJ(
      dossierHommesDesBois,
      "Geirbald the Kinslayer",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
      17,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor36 = await this.ajouteUnPNJ(
      dossierHommesDesBois,
      "Ingomer Axe-breaker",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor37 = await this.ajouteUnPNJ(
      dossierHommesDesBois,
      "Mogdred",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      6,
    ...
    let monActor38 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Hunald, the Bewitched Assassin",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
      0,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor39 = await this.ajouteUnPNJ(
      dossierDale,
      "Bardide Noble",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      6,
    ...
    let monActor40 = await this.ajouteUnPNJ(
      dossierDale,
    ...
    let monActor41 = await this.ajouteUnPNJ(
      dossierDale,
      "Elstan's Men",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
    ...
    let monActor42 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Halbrech",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor43 = await this.ajouteUnPNJ(
      dossierViglundings,
      "Viglund",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      7,
    ...
    let monActor44 = await this.ajouteUnPNJ(
      dossierViglundings,
      "Viglar, son of Viglund",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
      19,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor45 = await this.ajouteUnPNJ(
      dossierViglundings,
      "Saviga the Goblin",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
    ...
    let monActor46 = await this.ajouteUnPNJ(
      dossierViglundings,
      "Thunar",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor47 = await this.ajouteUnPNJ(
      dossierViglundings,
      "Aestid, daughter of Viglund",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
      20,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor48 = await this.ajouteUnPNJ(
      dossierHommesAnduin,
      "Amfossa the Trapper",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor49 = await this.ajouteUnPNJ(
      dossierHommesAnduin,
      "Hwalda",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
    ...
    let monActor50 = await this.ajouteUnPNJ(
      dossierHommesAnduin,
      "Mab the Spinner",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
    ...
    let monActor51 = await this.ajouteUnPNJ(
      dossierHommesAnduin,
      "Cruac the Outlaw",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor52 = await this.ajouteUnPNJ(
      dossierHommesAnduin,
      "Tom the Black",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor53 = await this.ajouteUnPNJ(
      dossierHommesAnduin,
      "Valderic",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor54 = await this.ajouteUnPNJ(
      dossierHommesAnduin,
      "Arciryas",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor55 = await this.ajouteUnPNJ(
      dossierHommesAnduin,
      "Vidugalum",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor56 = await this.ajouteUnPNJ(
      dossierEriador,
      "Ostley the Mad",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
      15,
      "<p><em>Fondcombe, page 62</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor57 = await this.ajouteUnPNJ(
      dossierEriador,
      "Arbarad",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      6,
    ...
    let monActor58 = await this.ajouteUnPNJ(
      dossierEriador,
      "Talandil",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      6,
      20,
      "<p><em>Fondcombe, page 59</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor59 = await this.ajouteUnPNJ(
      dossierEriador,
      "Hiraval, son of Hirgeleb",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      7,
      20,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor60 = await this.ajouteUnPNJ(
      dossierEriador,
      "Edrahil, son of Hiraval",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
      12,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor61 = await this.ajouteUnPNJ(
      dossierEriador,
      "Arnulf the Leofide",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor62 = await this.ajouteUnPNJ(
      dossierDale,
      "Gwina",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
    ...
    let monActor63 = await this.ajouteUnPNJ(
      dossierEriador,
      "Kyna",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
      18,
      "<p><em>Fondcombe, page 65</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor64 = await this.ajouteUnPNJ(
      dossierEriador,
      "Bradan",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
      19,
      "<p><em>Fondcombe, page 66</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor65 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Elven Boatman",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      4,
      0,
      "<p><em>See Core Rule Book</em></p>",
      false,
    ...
    let monActor66 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Woodland Elf Envoy",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      6,
    ...
    let monActor67 = await this.ajouteUnPNJ(
      dossierEsgaroth,
      "Woodland Elf Sentinel",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      6,
      18,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor68 = await this.ajouteUnPNJ(
      dossierElfesForetNoire,
      "King Thranduil",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      9,
      60,
    ...
    let monActor69 = await this.ajouteUnPNJ(
      dossierElfesFondcombe,
      "Elrond",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      9,
      0,
      "<p><em>Fondcombe, page 13</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor70 = await this.ajouteUnPNJ(
      dossierElfesFondcombe,
      "Arwen Undómiel",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      7,
      0,
      "<p><em>Fondcombe, page 15</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor71 = await this.ajouteUnPNJ(
      dossierElfesFondcombe,
      "Glorfindel",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      9,
      0,
      "<p><em>Fondcombe, page 16</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor72 = await this.ajouteUnPNJ(
      dossierElfesFondcombe,
      "Aiwiel",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      5,
      0,
      "<p><em>Fondcombe, page 33</em></p>",
      false,
      true,
      CONST.TOKEN_DISPOSITIONS.NEUTRAL
    );
    let monActor73 = await this.ajouteUnPNJ(
      dossierElfesFondcombe,
      "Gondril",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      5,
    ...
    let monActor74 = await this.ajouteUnPNJ(
      dossierElfesLorien,
      "Cendre",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      8,
    ...
    let monActor75 = await this.ajouteUnPNJ(
      dossierElfesLorien,
      "Haldir",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      8,
    ...
    let monActor76 = await this.ajouteUnPNJ(
      dossierHobbits,
      "Byrgol",
      "modules/fvtt-tor1e-compendium/icons/pnj-hobbit.webp",
      3,
      13,
      "<p><em>See Core Rule Book</em></p>",
      false,
    ...
    let monActor77 = await this.ajouteUnPNJ(
      dossierHobbits,
      "Folulf and Arnulf",
      "modules/fvtt-tor1e-compendium/icons/pnj-hobbit.webp",
      4,
    ...
    let monActor78 = await this.ajouteUnPNJ(
      dossierHobbits,
      "Elwin",
      "modules/fvtt-tor1e-compendium/icons/pnj-hobbit.webp",
      4,
    ...
    let monActor79 = await this.ajouteUnPNJ(
      dossierHobbits,
      "Fay",
      "modules/fvtt-tor1e-compendium/icons/pnj-hobbit.webp",
      5,
    ...
    let monActor80 = await this.ajouteUnPNJ(
      dossierHobbits,
      "Herbert",
      "modules/fvtt-tor1e-compendium/icons/pnj-hobbit.webp",
      3,
    ...
    let monActor81 = await this.ajouteUnPNJ(
      dossierNains,
      "Stone Guard",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor82 = await this.ajouteUnPNJ(
      dossierNains,
      "Iron Guard",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor83 = await this.ajouteUnPNJ(
      dossierNains,
      "Smith of Erebor",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      5,
    ...
    let monActor84 = await this.ajouteUnPNJ(
      dossierNains,
      "Mason of Erebor",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      5,
    ...
    let monActor85 = await this.ajouteUnPNJ(
      dossierNains,
    ...
    let monActor86 = await this.ajouteUnPNJ(
      dossierNains,
      "Munin, Keeper of the Archives",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      4,
      0,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor87 = await this.ajouteUnPNJ(
      dossierNains,
      "Glóin the Envoy",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor88 = await this.ajouteUnPNJ(
      dossierNains,
      "Óin the Healer",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor89 = await this.ajouteUnPNJ(
      dossierNains,
      "Bifur the Merchant",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor90 = await this.ajouteUnPNJ(
      dossierNains,
      "Bofur the Miner",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      5,
    ...
    let monActor91 = await this.ajouteUnPNJ(
      dossierNains,
      "Bombur the Fat",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      5,
    ...
    let monActor92 = await this.ajouteUnPNJ(
      dossierNains,
      "Balin the Statesman",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      7,
    ...
    let monActor93 = await this.ajouteUnPNJ(
      dossierNains,
      "Dori the Merchant",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      5,
    ...
    let monActor94 = await this.ajouteUnPNJ(
      dossierNains,
      "Dwalin the Warrior",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor95 = await this.ajouteUnPNJ(
      dossierNains,
      "Ori the Scribe",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      5,
    ...
    let monActor96 = await this.ajouteUnPNJ(
      dossierDale,
      "Merchant of Dale",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor97 = await this.ajouteUnPNJ(
      dossierDale,
      "Smith of the Hammer Street",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      5,
      0,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor98 = await this.ajouteUnPNJ(
      dossierDale,
      "Bardide Courtier",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor99 = await this.ajouteUnPNJ(
      dossierDale,
      "Guard of Dale",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor100 = await this.ajouteUnPNJ(
      dossierDale,
    ...
    let monActor101 = await this.ajouteUnPNJ(
      dossierDale,
      "Healer of the Water House",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
      0,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor102 = await this.ajouteUnPNJ(
      dossierDale,
      "Bard the Dragon-slayer, King of Dale",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      6,
      26,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor103 = await this.ajouteUnPNJ(
      dossierDale,
      "Queen Una the Fair",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor104 = await this.ajouteUnPNJ(
      dossierDale,
      "Brindal, Clever Thief",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
      0,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor105 = await this.ajouteUnPNJ(
      dossierDale,
      "Bryni, Lord of Rivebourg",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
      19,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor106 = await this.ajouteUnPNJ(
      dossierDale,
      "Garrick of the Black Arrow",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
      19,
      "<p><em>See Core Rule Book</em></p>",
    ...
    let monActor107 = await this.ajouteUnPNJ(
      dossierDale,
      "Hakon, Bardide Noble",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor108 = await this.ajouteUnPNJ(
      dossierDale,
      "Erna",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
    ...
    let monActor109 = await this.ajouteUnPNJ(
      dossierDale,
      "Hakon, Bardide Noble",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor110 = await this.ajouteUnPNJ(
      dossierElfesForetNoire,
      "Ellaras the Seeker",
      "modules/fvtt-tor1e-compendium/icons/pnj-elfe.webp",
      6,
    ...
    let monActor111 = await this.ajouteUnPNJ(
      dossierNains,
      "Thorin Stonehelm",
      "modules/fvtt-tor1e-compendium/icons/pnj-nain.webp",
      6,
    ...
    let monActor112 = await this.ajouteUnPNJ(
      dossierDale,
      "Alduna",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      3,
    ...
    let monActor113 = await this.ajouteUnPNJ(
      dossierOrientaux,
      "Kajus the Oriental",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      4,
    ...
    let monActor114 = await this.ajouteUnPNJ(
      dossierDale,
      "Loore the Tracker",
      "modules/fvtt-tor1e-compendium/icons/pnj-homme.webp",
      5,
